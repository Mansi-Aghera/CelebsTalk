...
const transactions = [
  {
    id: 1,
    icon: <ShoppingBag size={20} className="text-[var(--dashboard-purple-icon-1)]" />,
    iconBg: "bg-[var(--dashboard-purple-icon-bg-1)]",
  ...
  {
    id: 2,
    icon: <Banknote size={20} className="text-[var(--green-200)]" />,
    iconBg: "bg-[var(--dashboard-green-icon-bg)]",
    title: "Weekly Salary",
  ...
  {
    id: 3,
    icon: <Utensils size={20} className="text-[var(--dashboard-purple-icon-2)]" />,
    iconBg: "bg-[var(--dashboard-purple-icon-bg-2)]",
  ...
  {
    id: 4,
    icon: <Plane size={20} className="text-[var(--secondary-200)]" />,
    iconBg: "bg-[var(--dashboard-purple-icon-bg-3)]",
  ...
  return (
    <div className="py-8 min-h-screen">
      <Container>
        ...
        >
          <Link href="/" className="hover:text-[var(--primary-300)] transition-colors">Home</Link>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex items-end gap-2 mb-10 md:mb-16">
              ...
              <span className="text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight">42,850.24</span>
            </div>
          ...
          >
            <div className="flex flex-col sm:flex-row lg:grid lg:grid-cols-2 gap-6 flex-1 h-full">
              ...
              <div className="flex-1 bg-white/90 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-[24px] p-6 border border-gray-100 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="text-gray-400 text-xs font-semibold uppercase tracking-wider mb-1 z-10">Monthly Growth</div>
                <div className="text-2xl lg:text-3xl font-bold text-gray-900 z-10">+12.4%</div>
              </div>
              ...
              <div className="flex-1 bg-white/90 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-[24px] p-6 border border-gray-100 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="text-gray-400 text-xs font-semibold uppercase tracking-wider mb-1 z-10">Total Savings</div>
                <div className="text-2xl lg:text-3xl font-bold text-gray-900 z-10">$8,240</div>
              </div>
            </div>
            ...
            <div className="bg-[var(--dashboard-card-dark)] rounded-[24px] p-6 py-7 flex items-center justify-between shadow-xl">
               <div>
                  <h3 className="text-white font-medium text-[15px] mb-1">Unlock 500₹ on next payment</h3>
                  <p className="text-gray-400 text-sm">Add min amount on your wallet</p>
               </div>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-4 px-2">
             <div>
                <h2 className="text-xl md:text-[22px] font-semibold text-gray-900 mb-1">Transaction History</h2>
                <p className="text-[13px] text-gray-500 font-medium">Your financial activity across all linked accounts</p>
             </div>
          ...
          <div className="bg-white rounded-[24px] md:rounded-[32px] p-4 md:p-8 md:px-10 shadow-[0_4px_30px_rgba(0,0,0,0.02)] border border-gray-100 overflow-x-auto no-scrollbar">
             <div className="min-w-[700px]">
               ...
               <div className="flex flex-col gap-1">
                 {transactions.map((tx) => (
                    <div key={tx.id} className="grid grid-cols-12 items-center px-4 py-4 hover:bg-gray-50 rounded-2xl transition-colors">
                       <div className="col-span-4 flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${tx.iconBg}`}>
                             {tx.icon}
                          </div>
                          <div>
                             <div className="font-semibold text-[14px] text-gray-900 mb-0.5">{tx.title}</div>
                             <div className="text-[12px] text-gray-400 font-medium">{tx.subtitle}</div>
                          </div>
                       </div>
                       
                       <div className="col-span-3 text-[13px] text-gray-500 font-medium tracking-wide">
                          {tx.category}
                       </div>
                       ...
                       <div className={`col-span-2 text-right font-bold text-[14px] tracking-wide ${tx.isPositive ? 'text-[var(--green-200)]' : 'text-gray-900'}`}>
                          {tx.amount}
                       </div>
                    </div>
                 ))}
