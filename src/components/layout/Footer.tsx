...
<ul className="space-y-3 text-sm text-white/90">
  <li className="hover:text-[var(--primary-300)]"><Link href="#">About us</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Solutions</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Portfolio</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Blog</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Contact</Link></li>
</ul>
</motion.div>
...
<ul className="space-y-3 text-sm text-white/90">
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Privacy Policy</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Terms & Conditions</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Cookie Policy</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Blog</Link></li>
  <li className="hover:text-[var(--primary-300)]"><Link href="#">Contact</Link></li>
</ul>
</motion.div>
...
<div className="flex gap-6">
  <Link href="#" className="hover:text-[var(--primary-300)]">Twitter</Link>
  <Link href="#" className="hover:text-[var(--primary-300)]">YouTube</Link>
  <Link href="#" className="hover:text-[var(--primary-300)]">LinkedIn</Link>
</div>
</motion.div>
