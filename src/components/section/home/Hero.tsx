...
// //   <div className="absolute top-2 left-0 bg-gradient-to-br from-[#FFACCE] to-[#FFE4EF] px-4 py-3 rounded-[10px] shadow-md flex flex-col items-center">
...
// //     {/* 20L users badge */}
// //     <div className="absolute bottom-4 right-0 bg-gradient-to-br from-[#DEA9FF] to-[#F2E0FD] px-4 py-3 rounded-[10px] shadow-md flex flex-col items-center">
...
//             transition={{ 
//               duration: 0.6,
//               ease: [0.25, 0.1, 0.25, 1], // Same smooth easing
//               delay: 0.1 // Small delay but still feels immediate due to left content animation
//             }}
//             className="relative flex justify-center lg:justify-end"
//           >
//             {/* glow */}
